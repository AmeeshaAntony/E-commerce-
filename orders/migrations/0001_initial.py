    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elete_status', models.IntegerField(choices=[(1, 'Live'), (0, 'Delete')], default=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('order_status', models.IntegerField(choices=[(2, 'ORDER_PROCESSED'), (4, 'ORDER_REJECTED'), (3, 'ORDER_DELIVERED')], default=0)),
